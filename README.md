...
> Previous: [08 — Query Rewriting](https://github.com/BellaBe/rag-08-query-rewriting) | Next: [10 — Self-Reflective RAG](https://github.com/BellaBe/rag-10-self-reflective-rag)
...
Head to **[Tutorial 10 — Self-Reflective RAG](https://github.com/BellaBe/rag-10-self-reflective-rag)** to add an intelligent agent that evaluates retrieval quality before answering.
